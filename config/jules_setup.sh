...
SHADOW_TRADE__DURATION_MINUTES=1
SHADOW_TRADE__DURATION_RISE_FALL=1
SHADOW_TRADE__DURATION_TOUCH=5
SHADOW_TRADE__DURATION_RANGE=5
...
# Custom API
import deriv_api
print(f'✅ Deriv API loaded from: {deriv_api.__file__}')
